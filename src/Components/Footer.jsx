...
const Footer = () => {
  ...
  return (
    <>
      <div className="text-black bg-gray-400 relative h-[30px]"></div>
      <div className="bg-gray-400 text-white relative z-10  ">
        {/* Header Section */}
        ...
        <div className="bg-white text-center p-10 text-gray-800 flex flex-col items-center justify-center max-w-7xl mx-auto sm:p-8 space-y-12">
          <h2 className="text-3xl font-bold max-w-140 text-center">
            The <span className="text-pink-500">Exclusive portal</span> for
          ...
          <p className="mt-4 text-xl text-gray-500 max-w-223">
            <span className="font-Bricolage">arabbia.com</span>connects
            thousands of buyers to Dubai Property Developers, Dubai Real Estate
            Agencies, and Dubai Real Estate Brokers by providing the most
            accurate, latest, and authentic Project & Property listings.
          </p>
        </div>
